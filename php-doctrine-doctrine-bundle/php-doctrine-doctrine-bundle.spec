#
# RPM spec file for php-doctrine-doctrine-bundle
#
...
require_once 'Doctrine/Bundle/DoctrineCacheBundle/autoload.php';
require_once 'jdorn-sql-formatter/autoload.php';
