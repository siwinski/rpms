...
%global module_name views_customfield

Name:      drupal6-%{module_name}
Version:   1.0
Release:   1%{?dist}
Summary:   Provides a number of custom views fields (rownumber, phpcode, ...)
...
* Markup: Field that allows usage of custom text and the input filter system.
