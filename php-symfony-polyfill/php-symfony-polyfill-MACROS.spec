...
: Create macros
cat <<'MACROS' | tee macros.%{name}
%%php_symfony_polyfill_with_php54 %{with_php54}
%%php_symfony_polyfill_with_php55 %{with_php55}
%%php_symfony_polyfill_with_php56 %{with_php56}
%%php_symfony_polyfill_with_php70 %{with_php70}
MACROS
...
cp -p macros.%{name} %{buildroot}/%{macrosdir}/
