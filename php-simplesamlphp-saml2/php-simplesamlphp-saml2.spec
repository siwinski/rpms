...
: Move upstream temporary autoloader into SAML2 directory
mv src/_autoload.php src/SAML2/_autoload.php
sed 's/dirname(__FILE__)/dirname(dirname(__FILE__))/' \
    -i src/SAML2/_autoload.php
